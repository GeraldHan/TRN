'''
Model is referred to https://github.com/KaihuaTang/VQA2.0-Recent-Approachs-2018.pytorch
'''
import torch
import math
...
class Net(nn.Module):
    ...
    def forward(self, q, vision, e_s, e_e, e_mask, q_mask, r_mask, q_len):
        v = vision
        b = vision[:, : ,-4:]
        ...
        loss_time = torch.zeros_like(q_mask)
